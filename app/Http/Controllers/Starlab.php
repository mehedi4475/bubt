   ...
   // public $user = userPowerSession();
    ...
    public function loginVerification(Request $request){     
        ...
        if (Auth::attempt(array('username' => $username, 'password' => $password))){             
           ...
           //Current user power
            $userType =  Auth::user()->user_type; //user type student, teacher or admin
            $userUniqueId =  Auth::user()->id; //users table id
            $userId =  Auth::user()->user_id; //students or teacher table id
            
            //Create session for current user.
           
            Session::put('userType', $userType);
            Session::put('userUniqueId', $userUniqueId);
